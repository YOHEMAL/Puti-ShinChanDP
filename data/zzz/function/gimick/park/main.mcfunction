# 時計回りの回転
execute as @e[type=armor_stand,tag=hummer] at @s if score @s park matches -180.. run scoreboard players add @s park 9
...
execute as @e[type=armor_stand,tag=reverse_hummer] at @s if score @s park matches ..180 run scoreboard players remove @s park 9
...
execute as @e[type=armor_stand,tag=hummer_90] at @s if score @s park matches -180.. run scoreboard players add @s park 9
...
execute as @e[type=armor_stand,tag=reverse_hummer_90] at @s if score @s park matches ..180 run scoreboard players remove @s park 9
